...
<body class="about-page">
    ...
    <section class="templatemo-top-section">
        <div class="templatemo-header">
            ...
            <ul align="left">
                <li><a href="http://localhost/User//View/login.php">Login</a></li>
                <li><a href="http://localhost/User//View/Registre.php">Sign up</a></li>
            </ul>
        </div>
                            ...
                            <li>
                                <div class="about-slider">
                                    ...
                                    <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12 about-slider-description">
                                        ...
                                        <p class="welcome-message">Motor is free Bootstrap v3.3.4 responsive web template provided by <span class="blue">template</span><span class="green">mo</span>.com website. You can download, modify and use this for your website projects. Please
                                            tell your friends about our templates. Thank you for visiting. Have fun!</p>
                                    </div>
                                </div>
                            </li>
                            <li>
                                <div class="about-slider">
                                    ...
                                    <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12 about-slider-description">
                                        ...
                                        <p class="welcome-message">Lorem ipsum dolor sit amet, consectetuer adipiscing elit dori. Aenean commodo ligula eget. Aenean massa. Cumdent sociis natoque penatibus et magnis dis parturient montes, sor ind nascetur ridiculus mus. Lorem ipsum
                                            dolor sit amet dipiscing elit dori.</p>
                                    </div>
                                </div>
                            </li>
                        </ul>
    ...
    <section class="container margin-bottom-50">
        ...
        <div class="about-container">
            ...
            <div class="about-container-right">
                ...
                <p class="about-description">Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit. Duis sed odio sit amet nibh vulputate cursus a sit amet mauris. Morbi accumsan ipsum
